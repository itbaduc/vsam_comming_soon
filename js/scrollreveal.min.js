  ...
  return (
    function () {
      ...
      (this.ScrollReveal = (function () {
        function i(n) {
          return 'undefined' == typeof this || Object.getPrototypeOf(this) !== i.prototype
            ? new i(n)
            : ((e = this),
              (e.tools = new t()),
              e.isSupported()
        ...
        function d() {
          if (e.isSupported()) {
            ...
            e.initialized ||
              (window.addEventListener('scroll', y), window.addEventListener('resize', y), (e.initialized = !0));
          }
          return e;
        }
        function y() {
        ...
        function g(t, n) {
          ...
          (r.blocked = !0),
            ...
            t.sequence.timer &&
              ((i = Math.abs(t.sequence.timer.started - new Date())), window.clearTimeout(t.sequence.timer)),
        ...
        return (
          ...
          (i.prototype.reveal = function (t, n, i, l) {
            ...
            if (
              ...
              (y = e.tools.isNode(t) ? [t] : Array.prototype.slice.call(c.querySelectorAll(t))),
              !y.length)
            )
              return e;
            n && 'number' == typeof n && ((i = n), (n = {})),
              i &&
                'number' == typeof i &&
                ((w = r()), (g = e.sequences[w] = { id: w, interval: i, elemIds: [], active: !1 }));
            for (var v = 0; v < y.length; v++)
              (p = y[v].getAttribute('data-sr-id')),
                p
                  ? (m = e.store.elements[p])
                  : ((m = { id: r(), domEl: y[v], seen: !1, revealing: !1 }), m.domEl.setAttribute('data-sr-id', m.id)),

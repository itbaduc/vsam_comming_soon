$(document).ready(function () {
  ...
  function createMesh() {
    ...
    geometry = new FSS.Plane(
      MESH.width * rendererFSS.width,
      MESH.height * rendererFSS.height,
      MESH.segments,
      MESH.slices
    );
  ...
  function initMap(map) {
    ...
    var points = [
      [
        '<div class="wrapper"><h4>Kounter Office</h4><h5>Opening Hours</h5><p>Mo â€“ Fr: 08:30 â€“ 20:00</p></div>',
        40.7486332,
        -73.9797129,
      ],
      [
        '<div class="wrapper"><h4>Kounter Agency</h4><h5>Opening Hours</h5><p>Mo â€“ Fr: 08:30 â€“ 20:00</p></div>',
        40.6681,
        -73.9448,
      ],
    ];
